...
export const readOnlyBash: Record<string, "allow" | "ask" | "deny"> = {
  ...
  "cz-cli table partitions *": "allow",
  "cz-cli table storage *": "allow",
  "cz-cli table history *": "allow",
  "cz-cli vcluster list *": "allow",
  "cz-cli vcluster describe *": "allow",
  "cz-cli vcluster status *": "allow",
  "cz-cli vcluster metrics *": "allow",
  "cz-cli query *": "allow",
  "cz-cli get_context *": "allow",
  "cz-cli sql *": "allow",
  // czcode_change end
  "git *": "deny",
  "git log *": "allow",
...
export function patchAgents(
  ...
  // czcode_change start - Lakehouse agent tools and permissions
