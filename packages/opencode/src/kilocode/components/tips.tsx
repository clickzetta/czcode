...
const TIPS = [
  ...
  "czcode can {highlight}configure itself{/highlight} if you ask it",
  "Ask czcode to {highlight}add Supabase MCP globally{/highlight}",
  "Ask czcode to {highlight}create a review agent for this project{/highlight}",
  "Ask czcode to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask czcode to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask czcode to {highlight}make my review agent read-only{/highlight}",
  "Ask czcode to {highlight}require approval before git push{/highlight}",
  "Ask czcode to {highlight}turn off auto-formatting{/highlight}",
  "Ask czcode to {highlight}block access to .env files{/highlight}",
  "Ask czcode to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask czcode to {highlight}match my terminal theme{/highlight}",
  "Ask czcode to {highlight}disable sharing for all sessions{/highlight}",
  "Ask czcode to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask czcode to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask czcode to {highlight}save this workflow as a /command{/highlight}",
  "czcode auto-handles OAuth for remote MCP servers requiring auth",
  "czcode auto-formats files using prettier, gofmt, ruff, and more",
  "czcode uses LSP servers for intelligent code analysis",
  "Use {highlight}czcode run{/highlight} for non-interactive scripting",
  "Use {highlight}czcode --continue{/highlight} to resume the last session",
  "Use {highlight}czcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}czcode serve{/highlight} for headless API access to czcode",
  "Use {highlight}czcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}czcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}czcode auth list{/highlight} to see all configured providers",
  ...
  // czcode_change start — Lakehouse data tips
  "Use {highlight}/cz_sample{/highlight} to quickly preview table data",
  "Use {highlight}/cz_count{/highlight} to check table row counts",
  "Use {highlight}/cz_profile{/highlight} to generate data quality reports",
  "Use {highlight}/cz_role{/highlight} or {highlight}Tab{/highlight} to switch between data roles (analyst/engineer/dba/governance)",
  "Use {highlight}/cz_vcluster{/highlight} to check VCluster status",
  "Use {highlight}/cz_sql_history{/highlight} to browse and copy past SQL queries",
