      ...
      .add(
        HttpApiEndpoint.get("get", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the current OpenCode configuration settings and preferences.", // kilocode_change
          }),
        ),
        HttpApiEndpoint.patch("update", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Update OpenCode configuration settings and preferences.", // kilocode_change
          }),
        ),
